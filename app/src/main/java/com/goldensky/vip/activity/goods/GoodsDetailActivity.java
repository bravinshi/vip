...
public class GoodsDetailActivity extends BaseActivity<ActivityGoodsDetailBinding,
    ...
    public static final Integer KEY_FAKE_DATA_XUELIANTIE = 25;// 雪莲贴
    public static final Integer KEY_FAKE_DATA_BAICHA = 26;// 白茶
...
//        mLinearLayoutManager.setSmoothScrollbarEnabled(true);
    ...
    public void generateFakeData(Integer fakeKey) {
        ...
        }else if(fakeKey.equals(KEY_FAKE_DATA_XUELIANTIE)){

        }else if(fakeKey.equals(KEY_FAKE_DATA_BAICHA)){

...
import com.goldensky.vip.databinding.ActivityScienceBinding;
import com.goldensky.vip.viewmodel.PublicViewModel;

import java.util.ArrayList;
import java.util.List;

public class ScienceActivity extends BaseActivity<ActivityScienceBinding, PublicViewModel> {
    private CircleFocusAdapter adapter;
    private List<Integer> list=new ArrayList<>();

    @Override
    public void onFinishInit(Bundle savedInstanceState) {
        mBinding.topBarScience.setBackListener(new View.OnClickListener() {
            @Override

...
public class MallManageTestActivity extends BaseActivity<ActivityMallManageBinding, PublicViewModel> {
    ...
    public void onFinishInit(Bundle savedInstanceState) {
        ...
        mBinding.topBarMallManage.setRightListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Starter.startInviteCompanyActivity(MallManageTestActivity.this,null);
            }
        });
...
//        mBinding.tabMallManage.addTab(mBinding.tabMallManage.newTab().setText("分销"));
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Starter.startPromoteActivity(MallManageTestActivity.this,null);
            }
        });

...
//        LogUtils.d(contentView.getTop(), contentView.getBottom(), outRect.top, outRect.bottom);
    ...
    public static int getKeyboardHeight() {
        if (sKeyboardHeight <= 0) {
            sKeyboardHeight = SizeUtils.dp2px(300);
        }
        return sKeyboardHeight;
    }

    public static void installKeyboardHeight() {
        sKeyboardHeight = SPUtils.getInstance("SP_FILE_NAME").getInt("sp_keyboard_height", 0);
    }

    public static void saveKeyboardHeight(int keyboardHeight) {
        sKeyboardHeight = keyboardHeight;
        SPUtils.getInstance("SP_FILE_NAME").put("sp_keyboard_height", keyboardHeight);
    }
}
